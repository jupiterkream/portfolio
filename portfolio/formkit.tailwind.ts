...
export default {
  ...
  global: {
    ...
    message: 'space-x-1 inline-flex items-start text-xs text-red-600 leading-5 -ml-3',
    messages: 'mt-1 space-y-1 flex flex-col list-none',
    form: 'space-y-4',
  ...
  'family:box': {
    decorator:
      'block relative h-4 w-4 mr-2 rounded ring-1 ring-gray-300 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500 bg-white',
    decoratorIcon:
  ...
  'family:text': {
    ...
    inner: 'flex items-center rounded-lg',
    input:
      'p-3 w-full border border-gray-300 formkit-invalid:border-red-600 read-only:bg-gray-100 placeholder-gray-400 rounded-lg'
  },
  'family:date': {
    inner:
  ...
  file: {
    fileItem: 'flex items-center text-gray-800  last:mb-0',
  ...
  range: {
    ...
    input: '$reset w-full  h-2 p-0 rounded-full',
    prefixIcon:
  ...
  select: {
    inner:
      'flex relative items-center rounded-lg border border-gray-300 formkit-invalid:border-red-600 [&>span:first-child]:focus-within:text-blue-500',
    input:
      'w-full p-3 pr-8 border-none formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit rounded-lg',
    selectIcon:
      'flex p-[3px] shrink-0 w-5 mr-0 -ml-[1.5em] h-full pointer-events-none [&>svg]:w-[1em]',
  ...
  textarea: {
    ...
    inner: 'flex items-center rounded-lg',
    input:
      'p-3 w-full min-h-[8rem] border border-gray-300 formkit-invalid:border-red-600 read-only:bg-gray-100 placeholder-gray-400 rounded-lg'
  },
  ...
  repeater: {
    ...
    fieldset: 'py-4 px-5',
    help: 'mb-2 mt-1.5',
    item: 'flex w-full  rounded border border-gray-200',
